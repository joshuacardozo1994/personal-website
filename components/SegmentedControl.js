...
import Styles from '../styles/segmented-control.module.scss'

const SegmentedControl = ({ uniqueID, index, setTheme }) => {
    return (
        <div className={Styles['ios13-segmented-control']}>
			<span className={Styles.selection} style={{ transform: `translateX(${index * 100}%)` }}></span>
